...
func (c *demoClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
...
func (UnimplementedDemoServer) SayHello(context.Context, *HelloRequest) (*HelloResp, error) {
